...
#define Rte_Call_rpIOSetSlide_Opr_IOSetForward 			Rte_Call_SlideMotor_rpIOSetSlide_IOSetForward
#define Rte_Call_rpIOSetSlide_Opr_IOSetReverse 			Rte_Call_SlideMotor_rpIOSetSlide_IOSetReverse
