...
#define Rte_IsUpdated_rpSeatCtrlData_DE_Height 		Rte_IsUpdated_HMI_rpSeatCtrlData_Height
#define Rte_IsUpdated_rpSeatCtrlData_DE_Incline 		Rte_IsUpdated_HMI_rpSeatCtrlData_Incline
#define Rte_IsUpdated_rpSeatCtrlData_DE_Slide 			Rte_IsUpdated_HMI_rpSeatCtrlData_Slide
#define Rte_Write_ppSeatCtrlBtns_DE_HeightBtnState 	Rte_Write_HMI_ppSeatCtrlBtns_HeightBtnState
#define Rte_Write_ppSeatCtrlBtns_DE_InclineBtnState 	Rte_Write_HMI_ppSeatCtrlBtns_InclineBtnState
#define Rte_Write_ppSeatCtrlBtns_DE_SlideBtnState 		Rte_Write_HMI_ppSeatCtrlBtns_SlideBtnState
