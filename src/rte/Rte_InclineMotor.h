...
#define Rte_Call_rpIOSetIncline_Opr_IOSetForward 		Rte_Call_InclineMotor_rpIOSetIncline_IOSetForward
#define Rte_Call_rpIOSetIncline_Opr_IOSetReverse 		Rte_Call_InclineMotor_rpIOSetIncline_IOSetReverse
