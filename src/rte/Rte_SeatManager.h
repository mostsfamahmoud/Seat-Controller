...
#define Rte_Read_rpSeatCtrlBtns_DE_HeightBtnState		Rte_Read_SeatManager_rpSeatCtrlBtns_HeightBtnState
#define Rte_Read_rpSeatCtrlBtns_DE_InclineBtnState		Rte_Read_SeatManager_rpSeatCtrlBtns_InclineBtnState
#define Rte_Read_rpSeatCtrlBtns_DE_SlideBtnState		Rte_Read_SeatManager_rpSeatCtrlBtns_SlideBtnState
#define Rte_Call_rpHeightMotor_Opr_Move					Rte_Call_SeatManager_rpHeightMotor_Move
#define Rte_Call_rpInclineMotor_Opr_Move				Rte_Call_SeatManager_rpInclineMotor_Move
#define Rte_Call_rpSlideMotor_Opr_Move					Rte_Call_SeatManager_rpSlideMotor_Move
#define Rte_Call_rpHeightSensor_Opr_GetPosition			Rte_Call_SeatManager_rpHeightSensor_GetPosition
#define Rte_Call_rpSlideSensor_Opr_GetPosition			Rte_Call_SeatManager_rpSlideSensor_GetPosition
#define Rte_Call_rpInclineSensor_Opr_GetPosition		Rte_Call_SeatManager_rpInclineSensor_GetPosition
#define Rte_Call_rpWeightSensor_Opr_GetWeight			Rte_Call_SeatManager_rpWeightSensor_GetWeight
